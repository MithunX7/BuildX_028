import { CivicDefectCategory, BoundingBox } from "@/types/detection";
...
export async function detectDefectFromFrame(params: {
  ...
  // If a specific scene is selected, return its calibrated parameters
  if (params.sceneHint) {
  ...
  // Live camera stream default: cycle or detect based on active video
